...
public class UsersServiceImplTest {
    ...
    public void testIncorrectAlreadyAuthenticatedException() {
        assertThrows(AlreadyAuthenticatedException.class, () -> usersRepositoryMock.authenticate(CORRECT_PASSWORD_TRUE, CORRECT_PASSWORD_TRUE));
    }

    @Test
    public void testIncorrectEntityNotFoundException() {
        assertThrows(UsersRepository.EntityNotFoundException.class, () -> usersRepositoryMock.authenticate(INCORRECT_LOGIN_FALSE, CORRECT_PASSWORD_TRUE));
    }

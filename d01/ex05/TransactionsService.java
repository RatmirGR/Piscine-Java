...
public class TransactionsService {
    ...
    public String retrieveUserById(int userId) throws UserNotFoundException{
        return usersList.retrieveUserById(userId).getName();
    }
    ...
    public Transaction removeTransaction(UUID transId, int userId) throws TransactionNotFoundException, UserNotFoundException{
        ...
        return usersList.retrieveUserById(userId).getTransactions().removeTransactionById(transId);
    }
